const topics = ['introduction', 'arrays and slices', 'loops', 'maps', 'structs', 'pointers', "Receiver Functions", "interfaces", 'stringer', "channels", "Go routines", "More about channels", "More topics", "Golang Code Examples", "CRUD Project"];
