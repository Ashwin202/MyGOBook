...
for(const topic of topics) {
    desktopNavBars+= `<li class="nav-item"><a class="nav-link" href="#" data-file="./notes/${topic}.html" id="${topic}-link">${topic.toLocaleUpperCase()}</a></li>`;
    mobileNavBars+= `<li class="nav-item"><a class="nav-link" href="#" data-file="./notes/${topic}.html" id="mobile-${topic}-link">${topic.toLocaleUpperCase()}</a></li>`;
}
...
loadContent('./notes/introduction.html');
